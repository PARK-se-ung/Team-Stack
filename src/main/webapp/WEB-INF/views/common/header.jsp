...
<header class="header">
    <div class="row flex-row justify-content-between align-items-center">
        <!-- logo -->
        <div class="ms-3 col-lg-2 logo-container">
        ...
        <div class="col-lg-3 top-nav">
            <div class="align-items-center">
                ...
                <% if((loginUser.getUserType().equals(G) || loginUser.getUserType().equals(I))){ %>
                    <a class="me-2" href="${pageContext.request.contextPath}/mypage">마이페이지</a>
                <% } else { %>
                    <a class="me-2" href="${pageContext.request.contextPath}/manage">관리자페이지</a>
                <% } %>
                    <a class="me-2" href="${pageContext.request.contextPath}/logout.do">로그아웃</a>
